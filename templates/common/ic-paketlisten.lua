-- Paketlisten fuer image-customization.lua.
--
-- Reine Daten, keine Bedingungen. Wer die Listen anwendet, steht in
-- ic-usb.lua und ic-plattformen.lua.
--
-- Absichtlich global (kein "local"): include() teilt allen Teilen dieselbe
-- Umgebung, aber nur ueber globale Namen.
